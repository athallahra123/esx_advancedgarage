...
Config.BoatPoundPrice     = 10000 -- Boat Pound Price.
...
Config.PolicePounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 458.08, y = -1011.13, z = 27.47 },
		SpawnPoint = { x = 446.21, y = -1019.3, z = 28.58, h = 91.27 }
	},
	Pound_Sandy = {
		PoundPoint = { x = 1699.31, y = 3594.69, z = 34.58 },
		SpawnPoint = { x = 1712.24, y = 3594.14, z = 35.41, h = 206.92 }
	},
	Pound_Paleto = {
...
Config.AmbulancePounds = {
	Pound_LosSantos = {
		PoundPoint = { x = 458.7, y = -1007.94, z = 27.47 },
		SpawnPoint = { x = 446.21, y = -1019.3, z = 28.58, h = 91.27 }
	},
	Pound_Sandy = {
		PoundPoint = { x = 1699.31, y = 3594.69, z = 34.58 },
		SpawnPoint = { x = 1702.75, y = 3602.65, z = 35.43, h = 207.18 }
	},
	Pound_Paleto = {
		PoundPoint = { x = -223.6, y = 6243.37, z = 30.49 },
		SpawnPoint = { x = -230.88, y = 6255.89, z = 30.49, h = 136.5 }
...
Config.CarGarages = {
	Garage_CentralLS = {
		GaragePoint = { x = 221.51, y = -811.68, z = 29.8 },
		SpawnPoint = { x = 231.51, y = -794.6, z = 30.58, h = 165.12 },
		DeletePoint = { x = 223.797, y = -760.415, z = 29.82 }
	},
	--[[Garage_Sandy = {
		GaragePoint = { x = 733.37, y = 2523.51, z = 72.22 },
		SpawnPoint = { x = 737.96, y = 2512.56, z = 73.23, h = 270.86 },
		DeletePoint = { x = 732.16, y = 2532.1, z = 72.21 }
	},]]
	Garage_Paleto = {
		GaragePoint = { x = 128.7822, y = 6622.9965, z = 30.7828 },
		SpawnPoint = { x = 128.7822, y = 6622.9965, z = 30.7828, h = 315.01 },
		DeletePoint = { x = 126.3572, y = 6608.4150, z = 30.8565 }
	},
	Garage_Walkot = {
		GaragePoint = { x = -409.67, y = 1219.48, z = 324.64 },
		SpawnPoint = { x = -409.67, y = 1219.48, z = 325.64, h = 163.11 },
		DeletePoint = { x = -389.55, y = 1214.23, z = 324.64 }
	},
	--[[Garage_Pedagang = {
		GaragePoint = { x = -599.2, y = 185.86, z = 69.46 },
		SpawnPoint = { x = -599.2, y = 185.86, z = 69.46, h = 87.56 },
		DeletePoint = { x = -597.62, y = 198.04, z = 70.35 }
	},]]
	Garage_Billy = {
		GaragePoint = { x = 1031.58, y = -760.91, z = 57.91 },
		SpawnPoint = { x = -135.18, y = 902.94, z = 234.77, h = 316.64 },
		DeletePoint = { x = 1033.64, y = -788.85, z = 57.91 }
	},	
	Garage_Lounge = {
		GaragePoint = { x = -1632.37, y = -937.34, z = 7.73 },
		SpawnPoint = { x = -1632.37, y = -937.34, z = 8.03, h = 140.32 },
		DeletePoint = { x = -1639.91, y = -923.47, z = 7.73 }
	},
	--[[Garage_Motel = {
		GaragePoint = { x = 327.8, y = -204.52, z = 53.09 },
		SpawnPoint = { x = 327.8, y = -204.52, z = 53.09, h = 159.74 },
		DeletePoint = { x = 331.92, y = -206.17, z = 53.09 }
	}]]
...
Config.CarPounds = {
	Pound_LosSantos = {
		PoundPoint = { x = -178.99, y = 314.17, z = 96.94 },
		SpawnPoint = { x = -199.1, y = 303.05, z = 96.95, h = 2.42 }
	},
	Pound_Sandy = {
		PoundPoint = { x = 1697.27, y = 3595.76, z = 34.6 },
		SpawnPoint = { x = 1702.75, y = 3602.65, z = 35.43, h = 207.18 }
	},
	Pound_Paleto = {
...
Config.PrivateCarGarages = {
	...
	Garage_Test = {
		Private = "test",
		GaragePoint = { x = 1060.48, y = -386.05, z = 66.85 },
		SpawnPoint = { x = 1056.43, y = -387.17, z = 66.85, h = 218.29 },
		DeletePoint = { x = 1050.28, y = -379.78, z = 67.85 }
	},
	Garage_unii = {
		Private = "unii",
		GaragePoint = { x = -2585.3, y = 1925.61, z = 166.32 },
		SpawnPoint = { x = -2588.14, y = 1930.94, z = 166.3, h = 275.72 },
		DeletePoint = { x = -2596.79, y = 1929.94, z = 166.31 }
	},
	Garage_botak = {
		Private = "botak",
		GaragePoint = { x = -101.17, y = 832.81, z = 234.72 },
		SpawnPoint = { x = -105.01, y = 834.34, z = 235.69, h = 7.8 },
		DeletePoint = { x = -104.25, y = 822.6, z = 234.73 }
	},
	Garage_mowski = {
		Private = "mowski",
		GaragePoint = { x = -1521.91, y = 855.26, z = 180.56 },
		SpawnPoint = { x = -1519.44, y = 866.52, z = 181.7, h = 345.09 },
		DeletePoint = { x = -1523.87, y = 859.05, z = 180.63 }
	},
	Garage_din = {
		Private = "din",
		GaragePoint = { x = -1524.32, y = 81.62, z = 56.02 },
		SpawnPoint = { x = -1524.32, y = 81.62, z = 56.62, h = 279.16 },
		DeletePoint = { x = -1532.4, y = 82.84, z = 56.15 }
	},
	...
	Garage_HillcrestAvenue2874 = {
		...
		GaragePoint = { x = -1508.46, y = 28.41, z = 55.08 },
		SpawnPoint = { x = -1504.89, y = 26.57, z = 55.3, h = 358.2 },
		DeletePoint = { x = -1504.45, y = 22.03, z = 55.32 }
	},
